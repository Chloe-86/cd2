...
<div class="main-container">
	...
	echo '<h2 id="leblog" class="chic-title">Dernières publications sur nos créateurs</h2>';
	...
	echo '</ul>';
	echo '<p class="text-center"><a class="chic-bouton" href="/chicdressingnew/#leblog">Voir tous les articles</a></p>';
